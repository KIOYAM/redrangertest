    ...
    return (
        ...
        >
            <div className="mx-auto max-w-7xl">
                <div className="relative overflow-hidden rounded-xl border border-white/[0.08] bg-[#1A1A22]/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#FF003D]/5 via-transparent to-[#00C4FF]/5" />
                    ...
                    <div className="relative flex items-center justify-between px-6 py-4">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="/">
                                ...
                                >
                                    <div className="h-8 w-8 rounded-lg bg-[#FF003D] flex items-center justify-center shadow-lg shadow-[#FF003D]/30">
                                        <Zap className="text-[#FFC700] h-5 w-5" />
                                    </div>
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <motion.button
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#FF003D]/10 border border-[#FF003D]/30 hover:border-[#FF003D]/50 text-white transition-all"
                                    >
                                ...
                                <DropdownMenuContent className="w-56 bg-[#1A1A22] border-white/[0.08] backdrop-blur-xl">
                        ...
                        <div className="flex items-center gap-2">
                                    ...
                                    <Link key={item.href} href={item.href}>
                                        <motion.div
                                            ...
                                            className={`relative px-4 py-2 rounded-lg transition-all ${isActive
                                                    ? 'bg-[#FF003D]/20 text-white border border-[#FF003D]/30'
                                                    : 'text-[#B3B3B8] hover:text-white hover:bg-white/[0.05]'
                                                }`}
                                        >
                            ...
                            <motion.button
                                ...
                                className="ml-2 px-4 py-2 rounded-lg bg-[#FF003D]/10 text-[#FF003D] hover:bg-[#FF003D]/20 transition-all flex items-center gap-2 border border-[#FF003D]/30"
                            >
